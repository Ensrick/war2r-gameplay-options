...
# Army mix per hall tier, in percent. Land and ships are split by the map first (see navy_weight above), then these
# shares are spread over what you can actually train; a class you cannot build yet gives its share to the others.
# Plenty of gold and little lumber makes the cheap classes grow by themselves.
