...
def front_1300(lines, tree, notes):
    if 'auto_production' in tree:
        insert_after_key(lines, tree, 'auto_production', 'reserve_navy_food', FRONT_1300, notes)


def navy_food_1290(lines, tree, notes):
    if 'auto_production' in tree:
        insert_after_key(lines, tree, 'auto_production', 'navy_max', NAVY_FOOD_1290, notes)
